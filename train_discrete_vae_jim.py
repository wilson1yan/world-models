...
from models.discrete_vae_jim import DiscreteVAE
...
vae_dir = join(args.logdir, args.dataset, 'discretevae_jim')
...
if not args.noreload and exists(reload_file):
    ...
    if args.model == 'vae':
        model = DiscreteVAE((3, RED_SIZE, RED_SIZE), 64, n_categories)
    else:
