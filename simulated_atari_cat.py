...
if __name__ == '__main__':
    ...
    def get_action():
        if 'down' in keys_pressed and 'left' in keys_pressed and 'space' in keys_pressed:
            return 17
        elif 'down' in keys_pressed and 'right' in keys_pressed and 'space' in keys_pressed:
            return 16
        elif 'up' in keys_pressed and 'left' in keys_pressed and 'space' in keys_pressed:
            return 15
        elif 'up' in keys_pressed and 'right' in keys_pressed and 'space' in keys_pressed:
            return 14
        elif 'down' in keys_pressed and 'space' in keys_pressed:
            return 13
        elif 'left' in keys_pressed and 'space' in keys_pressed:
            return 12
        elif 'right' in keys_pressed and 'space' in keys_pressed:
            return 11
        elif 'up' in keys_pressed and 'space' in keys_pressed:
            return 10
