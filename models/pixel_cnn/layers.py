...
import models.pixel_cnn.util as util
import sys
...
class MaskedConv2d(nn.Module):
    ...
    """
    def __init__(self, channels, colors, self_connection=False, res_connection=True, hv_connection=True,
                 gates=True, k=7, padding=3):
        """
        This is the "vanilla" masked CNN. Note that this creates a blind spot in the receptive field when stacked.
...
class CMaskedConv2d(nn.Module):
    ...
    """
    def __init__(self, input_size, conditional_size, channels, colors=3, self_connection=False,
                 res_connection=True, hv_connection=True, gates=True, k=7, padding=3):
